...
// From Triangulate Efficient Triangulation Algorithm Suitable for Terrain Modelling. C++ version by Gilles Dumoulin
...
int CircumCircle(double xp, double yp, double x1, double y1, double x2, double y2, double x3, double y3, double& xc, double& yc,
                 double& r) {
...
void outputtriangle(int& nv, XYZ p[], ITRIANGLE v[], int& ntri) {
    ...
    for (int i = 0; i < ntri; i++) {  // replace cout by a compatible lineto to trace
        cout << (int)p[v[i].p1].x << " " << (int)p[v[i].p1].y << " " << (int)p[v[i].p2].x << " " << (int)p[v[i].p2].y << "\n";
        cout << (int)p[v[i].p2].x << " " << (int)p[v[i].p2].y << " " << (int)p[v[i].p3].x << " " << (int)p[v[i].p3].y << "\n";
        cout << (int)p[v[i].p3].x << " " << (int)p[v[i].p3].y << " " << (int)p[v[i].p1].x << " " << (int)p[v[i].p1].y << "\n";
    }
}
